...
class job_card_history(models.TransientModel):
    _name = 'job.card.history'
    ...
    def print_job_card_history_report(self):
        return self.env.ref('dev_garage_management.dev_job_card_history_report_menu').report_action(self)
