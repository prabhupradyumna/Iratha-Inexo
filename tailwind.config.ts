...
const config: Config = {
  ...
  theme: {
    extend: {
      ...
      fontSize: {
        "heading-1": ["45px", "54px"], // Reduced from 60px/72px (75%)
        "heading-2": ["36px", "43.5px"], // Reduced from 48px/58px (75%)
        "heading-3": ["30px", "36px"], // Reduced from 40px/48px (75%)
        "heading-4": ["26px", "34px"], // Reduced from 35px/45px (75%)
        "heading-5": ["21px", "30px"], // Reduced from 28px/40px (75%)
        "heading-6": ["18px", "22.5px"], // Reduced from 24px/30px (75%)
        "body-2xlg": ["16.5px", "21px"], // Reduced from 22px/28px (75%)
        "body-sm": ["10.5px", "16.5px"], // Reduced from 14px/22px (75%)
        "body-xs": ["9px", "15px"], // Reduced from 12px/20px (75%)
      },
      spacing: {
        4.5: "1.125rem",
        5.5: "1.375rem",
