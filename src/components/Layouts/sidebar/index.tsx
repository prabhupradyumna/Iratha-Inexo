    ...
    <>
      ...
      <aside
        className={cn(
          ...
          isMobile 
            ? (isOpen ? "w-full" : "w-0")
            : (isOpen ? "w-[260px] max-w-[260px]" : "w-[70px] max-w-[70px]"),
        )}
      ...
      >
        <div className={cn(
          ...
          isOpen ? "pl-[25px] pr-[7px]" : "pl-0 pr-0 items-center"
        )}>
          <div className={cn(
            "relative",
            isOpen ? "pr-4.5" : "w-full flex justify-center px-2"
          )}>
            <Link
              href={"/"}
            ...
            {!isMobile && (
              <button
                ...
                className={cn(
                  "absolute top-1/2 -translate-y-1/2 rounded-lg p-1.5 transition-all hover:bg-gray-100 dark:hover:bg-dark-2",
